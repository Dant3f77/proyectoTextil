...
<nav class="navbar bg-dark border-bottom border-body" data-bs-theme="dark">
  <div class="container-fluid">
    <!-- <a class="navbar-brand" href="#">Bienvenido  <?php echo $_SESSION['user']['nick']; ?></a>-->
    <h3 class="navbar-brand""> Bienvenido  <b class="text-warning"> <?php echo $_SESSION['user']['nombreEmpleado']; ?> </b></h3>
    <div>
